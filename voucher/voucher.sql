...
call fin_voucher('JISHOU_RE',date_sub(curdate(),interval 1 day),date_sub(curdate(),interval 1 day));
...
call fin_voucher('THIRD',date_sub(curdate(),interval 1 day),date_sub(curdate(),interval 1 day));

call fin_voucher('CASH',date_sub(curdate(),interval 1 day),date_sub(curdate(),interval 1 day));

call fin_voucher('BANK',date_sub(curdate(),interval 1 day),date_sub(curdate(),interval 1 day));

call fin_voucher('THIRD_BUG',date_sub(curdate(),interval 1 day),date_sub(curdate(),interval 1 day));

call fin_voucher('CASH_BUG',date_sub(curdate(),interval 1 day),date_sub(curdate(),interval 1 day));

call fin_voucher('BANK_BUG',date_sub(curdate(),interval 1 day),date_sub(curdate(),interval 1 day));
