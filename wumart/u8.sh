...
#java -jar ${path}/u8.jar C092 BD_ZV1 $1 $2    
 ...
 java -jar ${path}/u8.jar C112 KA_RV $1 $2
 java -jar ${path}/u8.jar C116 KA_RV $1 $2

 java -jar ${path}/u8.jar C092 KA_ZV2 $1 $2    
 java -jar ${path}/u8.jar C112 KA_ZV2 $1 $2
 java -jar ${path}/u8.jar C116 KA_ZV2 $1 $2
...
cd ${path}/data/${datapath}
 ...
 #tar -zcvf ${path}/data/${datapath}/fin_voucher_${dateago}.tar.gz ${path}/data/${datapath}/*
 #tar -cvf ./fin_voucher_${dateago}.tar ./*
