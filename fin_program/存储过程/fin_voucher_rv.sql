...
drop table if exists fin_certificate_rv;
...
drop table if exists fin_certificate_rv_detail;
...
drop table if exists fin_certificate_rv_detail_7;
...
drop table if exists fin_sale_bug;
CREATE TABLE `fin_sale_bug` (
  `zone_name` varchar(10) COMMENT '区域',
  `receipt_id` varchar(32) COMMENT '签收单',
  `money` decimal(16,2) COMMENT '金额',
  `pstng_date` varchar(16) COMMENT '时间'
...
#  call fin_voucher_rv('2017-09-14','2017-09-14',@rv);
