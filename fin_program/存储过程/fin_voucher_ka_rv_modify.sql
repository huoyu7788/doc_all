...
DROP PROCEDURE IF EXISTS fin_voucher_ka_rv_modify;  
  delimiter //
  create procedure fin_voucher_ka_rv_modify 
  (
  ...
  drop table if exists fin_certificate_ka_rv_detail_1;
  drop table if exists fin_certificate_ka_rv_detail_2;
  drop table if exists fin_certificate_ka_rv_detail_3;
  drop table if exists fin_certificate_ka_rv_detail_4;
  drop table if exists fin_certificate_ka_rv_detail_5;
  truncate table fin_certificate_ka_rv_detail_all;
  drop table if exists  fin_certificate_ka_rv_modify;

  set @strsql = 'delete from fin_certificate_result where dctype = ''KA_RV''';
 ...
 set @strsql = '
  ...
  set @strsql = '
    ...
    select zone_name,'''' receipt_id,'''' tax_rate,doc_type,dctype,doc_number,dd,project,project_cate,
      ...
      from fin_certificate_ka_rv_modify
  ...
  drop table fin_certificate_ka_rv_modify;
  
end
//

#    call fin_voucher_ka_rv_modify('2017-07-01','2017-07-10',@ka_rv);
