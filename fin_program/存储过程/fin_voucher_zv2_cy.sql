drop table if exists fin_certificate_zv2_cy;
...
drop table if exists fin_certificate_zv2_cy_detail;
...
DROP PROCEDURE IF EXISTS fin_voucher_zv2_cy;  
  ...
  set @strsql = 'delete from fin_certificate_result where dctype = ''ZV2_CY''';
...
set @strsql = '
      create table fin_certificate_zv2_cy_detail as 
...
select FOUND_ROWS() into zv2_cy_num;
  ...
  truncate table fin_certificate_zv2_cy_detail;
  drop table if exists fin_certificate_zv2_cy_detail;
