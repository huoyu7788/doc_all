drop table if exists fin_certificate_lkl_detail_bug_bug;
CREATE TABLE `fin_certificate_lkl_detail_bug_bug` (
...
DROP PROCEDURE IF EXISTS fin_vocher_bank_lkl_bug;  
  delimiter //
  create procedure fin_vocher_bank_lkl_bug 
  (
  ...
  set @strsql = 'delete from fin_certificate_lkl_detail_bug where pstng_date >= @pstng_date_start and pstng_date <= @pstng_date_end';
...
#call fin_certificate_lkl_detail_bug_bug('2017-09-10,'2017-09-10',@lkl_num);
