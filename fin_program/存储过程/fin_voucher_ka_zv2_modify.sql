...
DROP PROCEDURE IF EXISTS fin_voucher_ka_zv2_modify;  
  delimiter //
  create procedure fin_voucher_ka_zv2_modify 
  (
  ...
  set @strsql = '
        create table fin_certificate_ka_zv2_modify as 
  ...
  set @strsql = '
    ...
    select zone_name,'''' receipt_id,'''' tax_rate,doc_type,dctype,doc_number,dd,project,project_cate,
      ...
      from fin_certificate_ka_zv2_modify
  ...
  drop table fin_certificate_ka_zv2_modify;

end
//


#  call fin_voucher_ka_zv2_modify('2017-07-01','2017-07-10',@ka_zv2)
