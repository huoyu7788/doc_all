...
sql="
insert overwrite table default.mds_fin_third_pay_no_lkl partition(dt='$day')
  select '北京' as name,
         money as money_sxf_bj,
         0 as money_sxf_tj,
         0 as money_sxf_hz,
         0 as money_yszk,
         0 as money_nbwl_tj,
         ...
         b.flag as flag,
         a.module as module,
         a.pstng_date as pstng_date
    from
        (
        select module,
               sum(count_fee) as money,
               substr(transaction_time,1,10) as pstng_date
          from default.mds_fin_third_pay
         where name = '北京'
